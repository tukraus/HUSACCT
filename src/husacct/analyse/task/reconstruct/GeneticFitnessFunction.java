...
public class GeneticFitnessFunction extends FitnessFunction {
	...
	public GeneticFitnessFunction(int a_targetAmount) {
	...
	/**
	 * Determine the fitness of the given Chromosome instance. The higher the return value, the more fit the instance. This method should always
