...
public interface IValidateService extends IObservableService {
	...
	/**
	 * Gets all the Categories of all the available ruletypes The RuleTypeDTO contains RuleTypeDTOs The RuleTypeDTO contains ViolationTypeDTOs
	 * 
	 ...
	 * 
	 * @param logicalpathFrom
	 *            the 'from' logical path
	 * @param logicalpathTo
	 *            the 'to' logical path
	 ...
	 * 
	 * @param logicalpathFrom
	 *            the 'from' physical path
	 * @param logicalpathTo
	 *            the 'to' physical path
	 * @return an array of ViolationDTO's
	 */
	...
	/**
	 * Returns a list of supported extensions to which the diagrams can be exported
	 * 
	 ...
	 * 
	 * @param file
	 *            the file to write the violations to
	 * @param fileType
	 *            the type of file (extension)
	 * @param date
	 *            the date on which the violations have been found.
	 */
